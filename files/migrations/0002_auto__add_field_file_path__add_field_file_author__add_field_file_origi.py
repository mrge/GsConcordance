...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'files_file', 'path',
                      self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'File.author'
        db.add_column(u'files_file', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', null=True, to=orm['general.Author']),
                      keep_default=False)

        # Adding field 'File.original'
        db.add_column(u'files_file', 'original',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'files_file', 'path')

        # Deleting field 'File.author'
        db.delete_column(u'files_file', 'author_id')

        # Deleting field 'File.original'
        db.delete_column(u'files_file', 'original')
